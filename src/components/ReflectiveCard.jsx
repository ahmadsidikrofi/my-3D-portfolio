    ...
    <div
      ...
      <div
        ...
        <div
          ...
          <div
            className="flex items-center gap-1.5 text-[10px] font-bold tracking-[0.1em] px-2 py-1 bg-white/10 rounded border border-white/20">
        ...
        <div
          className="flex-1 flex flex-col justify-end items-center text-center gap-6 mb-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold tracking-[0.05em] m-0 mb-2 drop-shadow-md uppercase">{name || 'TYPE YOUR NAME'}</h2>
            <p className="text-xs tracking-[0.2em] opacity-70 m-0 uppercase">{role || 'ROLE / HOBBY'}</p>
          </div>
        </div>
