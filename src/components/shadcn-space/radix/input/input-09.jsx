...
const InputFloatingLabel = ({ label, placeholder, value, onChange, type, wrapperClassName, className, progress, onFocus, onBlur, ...props }) => {
  const id = useId()
  ...
  return (
    <div className={`group relative w-full ${wrapperClassName || ''}`}>
      ...
      <Input id={id} type={type} placeholder={placeholder} value={value} onChange={onChange} onFocus={onFocus} onBlur={onBlur} className={`dark:bg-background pr-10 ${className || ''}`} {...props} />
