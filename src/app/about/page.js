                    ...
                    >
                        {skills.map((skill, i) => (
                            <motion.div
                                ...
                                whileTap={{ scale: 0.92 }}
                                className="group relative flex flex-col items-center justify-center w-full aspect-square border-4 border-black dark:border-white bg-neutral-50 dark:bg-neutral-900 cursor-pointer shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,255,153,1)] transition-shadow"
                            >
                                <img
                                    src={skill.imageUrl}
                                    alt={skill.name}
                                    className="w-8 h-8 sm:w-10 sm:h-10 object-contain group-hover:invert transition-all duration-200"
                                />
                                <span className="mt-2 text-[10px] sm:text-xs font-mono font-bold uppercase tracking-wider text-center leading-tight group-hover:text-black transition-colors">
                                    {skill.name}
                                </span>
                            </motion.div>
                        ))}
